...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <br /><br /><br />
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" GridLines="Horizontal" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" Height="338px" style="margin-left: 141px" Width="530px">
                <Columns>
